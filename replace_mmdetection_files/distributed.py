...
class MMDistributedDataParallel(DistributedDataParallel):
    ...
    def train_step(self, data: Union[dict, tuple, list],
        ...
        with optim_wrapper.optim_context(self):
            ...
            losses = self._run_forward(data, epoch=epoch, mode='loss')
    ...
    def val_step(self, data: Union[dict, tuple, list], epoch: int = 0) -> list:
        ...
        """
        return self.module.val_step(data, epoch=epoch)

    def test_step(self, data: Union[dict, tuple, list], epoch: int = 0) -> list:
        ...
        Returns:
            list: The predictions of given data.
        """
        return self.module.test_step(data, epoch=epoch)

    def _run_forward(self, data: Union[dict, tuple, list], mode: str,
                     epoch: int = 0) -> Any:
