...
model = dict(
    ...
    backbone=dict(
        ...
        return_blocks=True),
    # ── Decoder: SSM query decoder, expand=1 (ablation vs v6 expand=2) ───
    # expand=1 sets d_inner = d_model = 256, matching Transformer parameter
    # budget. v6 used expand=2 (d_inner=512), ~2x decoder parameters.
    decoder=dict(
